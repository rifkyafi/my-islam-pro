...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0C1A1F] 
      ...
      {/* Ornament rings */}
      <div className="absolute rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none w-[680px] h-[680px] border border-[#C9A84C]/7" aria-hidden="true" />
      <div className="absolute top-1/2 left-1/2 pointer-events-none w-[520px] h-[520px] border border-[#C9A84C]/6 animate-[spin_80s_linear_infinite]" 
           style={{ transform: 'translate(-50%, -50%) rotate(45deg)' }} aria-hidden="true" />
      <div className="absolute top-1/2 left-1/2 pointer-events-none w-[360px] h-[360px] border border-[#C9A84C]/5 animate-[spin_60s_linear_infinite_reverse]" 
           style={{ transform: 'translate(-50%, -50%) rotate(22.5deg)' }} aria-hidden="true" />

      {/* Decorative star */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[180px] h-[180px] text-[#C9A84C]/6 pointer-events-none" aria-hidden="true">
        <StarSvg />
      </div>
      ...
      <div className="relative z-10 text-center max-w-[700px] px-8 pt-32 pb-16 flex flex-col items-center">
        ...
        <h1 className="font-cormorant text-[clamp(2.75rem,6.5vw,5rem)] font-light leading-[1.12] text-[#F2EBD9] mb-6 tracking-[-0.5px] animate-[fadeUp_0.9s_ease_0.4s_forwards] opacity-0">
          Hadis Berdasarkan
          <br />
          <em className="italic text-[#E2C07A]">Tema Kehidupan</em>
        </h1>
        ...
        <div className="flex flex-col items-center gap-2 animate-[fadeUp_1s_ease_1s_forwards] opacity-0" aria-hidden="true">
          <div className="w-[1px] h-12 bg-[linear-gradient(to_bottom,#C9A84C,transparent)] animate-[scrollPulse_2s_ease-in-out_infinite]" />
          <span className="text-[0.65rem] tracking-[3px] uppercase text-[#7A8F96]">Gulir ke bawah</span>
        </div>
      </div>
    </section>
  )
