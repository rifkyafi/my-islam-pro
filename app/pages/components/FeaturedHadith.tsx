    ...
    <section id="hadis-pilihan" className="bg-[#0C1A1F] py-8 md:pb-24">
      <div className="max-w-[1280px] mx-auto px-5 md:px-10">
        ...
        <div className="bg-[#132830] border border-[#C9A84C]/18 p-10 md:p-14 md:px-16 relative overflow-hidden">
          <div className="absolute -top-8 left-10 font-cormorant text-[14rem] text-[#C9A84C]/5 leading-none pointer-events-none select-none" aria-hidden="true">"</div>
          <p className="font-amiri text-2xl md:text-[2rem] md:leading-[2.1] text-right direction-rtl text-[#E2C07A] mb-8 relative z-10">{data.arabic}</p>
