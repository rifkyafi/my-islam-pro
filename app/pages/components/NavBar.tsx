  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] px-5 py-4.5 md:px-10 flex items-center justify-between bg-[#0C1A1F]/82 backdrop-blur-[18px] border-b border-[#C9A84C]/18">
      <Link href="/" className="flex items-center gap-2.5 no-underline">
        <span className="font-neirizi text-2xl text-[#C9A84C] leading-none">حديث</span>
      ...
      <ul className="hidden md:flex items-center gap-9 list-none">
        ...
        <li>
          <Link href="?search=true" scroll={false} className="px-5 py-2 border border-[#C9A84C]/42 text-[#C9A84C] text-[0.825rem] no-underline tracking-[0.5px] transition-all hover:bg-[#C9A84C]/12 hover:text-[#E2C07A]">
            Cari Hadis
          </Link>
        </li>
      </ul>
