...
<p className="font-cormorant text-2xl text-[#D48C46]">Data Tidak Ditemukan</p>
              ...
              <button
                ...
                className="mt-2 px-5 py-2 bg-[#D48C46]/10 border border-[#D48C46]/30 text-[#D48C46] rounded-md text-[0.8rem] hover:bg-[#D48C46]/20 transition-all"
              >
                Coba Lagi
              </button>
            </div>
            ...
            <div className="flex flex-col gap-5 mb-12">
              {bookData.hadiths.map((hadith) => (
                <div
                  ...
                  className="group relative bg-[var(--bg-card)] p-6 md:p-8 flex flex-col rounded-md transition-all hover:bg-[var(--bg-card-hover)] scroll-mt-28 target:ring-2 target:ring-[#D48C46]/60 target:bg-[var(--bg-card-hover)] overflow-hidden"
                >
